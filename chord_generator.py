...
def main():
    ...
    fluidsynth_path = r"./fluidsynth-2.4.3-win10-x64/bin/fluidsynth.exe"
    soundfont = "FluidR3_GM.sf2"  # Ensure this file exists or update the path accordingly.
    sample_rate = 44100
